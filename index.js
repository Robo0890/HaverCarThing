var Godot = (function() {
    ...
    return (function(Godot) {
        ...
        , function() {
            Module.async_finish = [new Promise(function(accept, reject) {
                setTimeout(accept, 0)
            }
            )]
        }
        ...
        var ___tm_timezone = (stringToUTF8("GMT", 2246576, 4),
        2246576);
...
Function('return this')()['Engine'] = (function() {
    ...
    ;
    Engine.prototype.init = /** @param {string=} basePath */
    function(basePath) {
        if (initPromise) {
            return initPromise;
        }
    ...
    Engine.prototype.startGame = function(execName, mainPack, extraArgs) {
        ...
        var me = this;
        return Promise.all([this.init(execName), this.preloadFile(mainPack, mainPack)]).then(function() {
